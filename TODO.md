...
- [x] Create a smoke-test CI workflow at .github/workflows/ci.yml that runs python -m compileall on backend/ to catch syntax errors on every push and pull_request (dependency-free; do not install heavy ML requirements in CI)
